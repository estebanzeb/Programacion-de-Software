...
namespace asp_servicios.Controllers
{
    ...
    {
        private IUniversidadesAplicacion? iAplicacion = null;
        private TokenController? tokenController;

        public UniversidadesController(IUniversidadesAplicacion? iAplicacion,
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Universidades>(

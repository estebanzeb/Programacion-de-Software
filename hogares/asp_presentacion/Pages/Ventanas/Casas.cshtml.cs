...
namespace asp_presentacion.Pages.Ventanas
{
    ...
    {
        private ICasasPresentacion? iPresentacion = null;

        public CasasModel(ICasasPresentacion iPresentacion)
        {
            try
            {
        ...
        [BindProperty] public List<Casas>? Lista { get; set; }
